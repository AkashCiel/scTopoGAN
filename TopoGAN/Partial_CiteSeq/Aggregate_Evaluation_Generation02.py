...
data_dir = "/home/nfs/asingh5/Unsupervised_Manifold_Alignment/GAN_Ensemble_Topology_Experiments/Partial_CiteSeq/Evaluation Results"
...
Aggregate_Results.to_csv(
    path_or_buf="{}/Aggregate Evaluation Results {}.csv".format(data_dir, model_suffix), header=True, index=False)
