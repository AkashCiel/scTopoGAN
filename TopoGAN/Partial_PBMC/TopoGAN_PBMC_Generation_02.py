...
model_01_name = "ATAC_to_RNA_Generator_{}_{}_MODEL_{}".format(epoch_01, core_suffix, model_01)
model_02_name = "ATAC_to_RNA_Generator_{}_{}_MODEL_{}".format(epoch_02, core_suffix, model_02)

data_dir = "/home/nfs/asingh5/Unsupervised_Manifold_Alignment/Data/PBMC Data"
load_path_prefix = "/home/nfs/asingh5/Unsupervised_Manifold_Alignment/GAN_Ensemble_Topology_Experiments/Partial_PBMC"
ensemble_path_prefix = "/home/nfs/asingh5/Unsupervised_Manifold_Alignment/GAN_Ensemble_Topology_Experiments/Partial_PBMC"
...
source_tech = Manifold_Data = pd.read_csv(
    "{}/{} TopoAE 8 Dimensions Partial.csv".format(data_dir, source_tech_name)
    , header=0, delimiter=',', index_col = 0)

target_tech = Manifold_Data = pd.read_csv(
    "{}/{} TopoAE 8 Dimensions Partial.csv".format(data_dir, target_tech_name)
    , header=0, delimiter=',', index_col = 0)
...
Annotation_Data_Source = pd.read_csv("{}/Annotations_{}_Partial.csv".format(data_dir, source_tech_name)
, header=0, delimiter=',', index_col = 0)
Annotation_Data_Target = pd.read_csv("{}/Annotations_{}_Partial.csv".format(data_dir, target_tech_name)
, header=0, delimiter=',', index_col = 0)
