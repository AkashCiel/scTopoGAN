...
annotations_data_dir = "Unsupervised_Manifold_Alignment/Data/CiteSeq Data"
...
tech_01_projected = pd.read_csv("{}/UnionCom_Integrated_Reduced_from_50_1000_{}_Partial_Small_{}.csv".format(integrated_data_dir, random_seed, tech_01)
, header=0, delimiter=',', index_col = 0)

tech_02_projected = pd.read_csv("{}/UnionCom_Integrated_Reduced_from_50_1000_{}_Partial_Small_{}.csv".format(integrated_data_dir, random_seed, tech_02)
, header=0, delimiter=',', index_col = 0)

Annotation_Data_01 = pd.read_csv("{}/{}_annotations.csv".format(annotations_data_dir, tech_01)
, header=0, delimiter=',', index_col = 0)
Annotation_Data_02 = pd.read_csv("{}/{}_annotations.csv".format(annotations_data_dir, tech_02)
, header=0, delimiter=',', index_col = 0)
...
evaluation_results.to_csv(
    path_or_buf="{}/Full Evaluation Results Partial CiteSeq {}.csv".format(results_data_dir, random_seed),
