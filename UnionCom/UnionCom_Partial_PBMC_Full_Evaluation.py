...
tech_01_projected = pd.read_csv("{}/UnionCom_Integrated_Reduced_from_50_1000_{}_Partial_{}.csv".format(integrated_data_dir, random_seed, tech_01)
, header=0, delimiter=',', index_col = 0)

tech_02_projected = pd.read_csv("{}/UnionCom_Integrated_Reduced_from_50_1000_{}_Partial_{}.csv".format(integrated_data_dir, random_seed, tech_02)
, header=0, delimiter=',', index_col = 0)
...
evaluation_results.to_csv(
    path_or_buf="{}/Full Evaluation Results PartialPBMC {}.csv".format(results_data_dir, random_seed),
