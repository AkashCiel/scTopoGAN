...
epochs = 1000
path_suffix = "Reduced_from_50_{}_{}_Partial".format(epochs, random_seed)
...
source_tech = pd.read_csv("{}/{} Processed Reduced Partial.csv".format(data_dir, source_tech_name), header=0, delimiter=',', index_col = 0)

target_tech = pd.read_csv("{}/{} Processed Reduced Partial.csv".format(data_dir, target_tech_name), header=0, delimiter=',', index_col = 0)
...
# Write to file
tech_01_projected.to_csv(path_or_buf="{}/PBMC Integrated Data/UnionCom_Integrated_{}_{}.csv".format(path_prefix, path_suffix, source_tech_name), header=True, index=True)
tech_02_projected.to_csv(path_or_buf="{}/PBMC Integrated Data/UnionCom_Integrated_{}_{}.csv".format(path_prefix, path_suffix, target_tech_name), header=True, index=True)
...
evaluation_results.to_csv(
    path_or_buf="{}/PBMC Evaluation Results/Evaluation Results_{}.csv".format(path_prefix, path_suffix),
