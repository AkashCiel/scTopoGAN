"""
    ...
    3. Load data
    4. Load first generation models as specified by user
	5. Train and store ensemble model
	6. Evaluate and store ensemble model
"""
import pandas as pd
...
# Pick top 2 models with the lowest average topological errors
# You can simply enter the model numbers recommended in the first generation run
model_01 = 2
model_02 = 0

random_seed = 1
# Models in the previous generation were stored every 100 epochs. It is recommended to pick the 1000 epoch models for
...
data_dir = "PBMC" # The latent embeddings will be loaded from this directory
...
core_suffix = "scTopoGAN_Generation02"
...
for epoch in epochs:
    ...
    if epoch == 1000:
        source_to_target.to_csv("{}/{}_Aligned.csv".format(data_dir, source_tech_name), header=True, index=True)
